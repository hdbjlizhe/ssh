...
public class CustomInvocationSecurityMetadataSourceService implements FilterInvocationSecurityMetadataSource {
	...
	//private SResourceRepository sResourceRepository;
	...
	/*
	 * public CustomInvocationSecurityMetadataSourceService(SResourceService
	 * sres,SRoleService sR) { this.sResourceService = sres; this.sRoleService = sR;
	 * loadResourceDefine(); }
	 */
